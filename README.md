...
- **BS Physics**, University of Maine (2020, Highest Honors). Thesis: *Investigating the Stability of Observed Low Semi-major Axis Exoplanetary Systems With Hypothetical Outer Planets Using The Program Mercury6*
- **MS Physics**, Drexel University (2022)
- **PhD Physics**, Drexel University (2025). Dissertation: *Pathway Formation and Dynamical Transitions by Neuronal Traveling Waves with Plasticity*
- Research includes simulation of spiking neuronal networks, data visualization, and computational modeling using Python.
